...
std::vector<std::unique_ptr<Card>> createAllCards() {
    ...
    // --- 时代 I 卡牌 ---
    cards.push_back(std::make_unique<Card>("Lumber Yard", 1, Color::BROWN, std::map<Resource, int>{}, std::vector<std::string>{}, "", [](Player& s, Game& g) { s.add_resource(Resource::WOOD, 1); }));
    cards.push_back(std::make_unique<Card>("Ore Vein", 1, Color::BROWN, std::map<Resource, int>{}, std::vector<std::string>{}, "", [](Player& s, Game& g) { s.add_resource(Resource::ORE, 1); }));
    cards.push_back(std::make_unique<Card>("Clay Pool", 1, Color::BROWN, std::map<Resource, int>{}, std::vector<std::string>{}, "", [](Player& s, Game& g) { s.add_resource(Resource::BRICK, 1); }));
    cards.push_back(std::make_unique<Card>("Stone Pit", 1, Color::BROWN, std::map<Resource, int>{}, std::vector<std::string>{}, "", [](Player& s, Game& g) { s.add_resource(Resource::STONE, 1); }));
    cards.push_back(std::make_unique<Card>("Timber Yard", 1, Color::BROWN, std::map<Resource, int>{{Resource::COIN, 1}}, std::vector<std::string>{}, "", [](Player& s, Game& g) { s.add_resource_choice({Resource::WOOD, Resource::STONE}, 1); }));
